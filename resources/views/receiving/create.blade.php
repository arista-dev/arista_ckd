                    ...
                    <form method="POST" action="{{ route('receiving.store') }}">
                        ...
                        <div class="mb-3">
                            <label class="form-label fw-semibold">
                                Container No <span class="text-danger">*</span>
                            </label>
                        ...
                        <div class="mb-4">
                            ...
                            <select name="ckd_model_id" class="form-select @error('ckd_model_id') is-invalid @enderror"
                                required>
                        ...
                        <div class="alert alert-info py-2" style="font-size:13px;">
                            ...
                            Receiving No akan di-generate otomatis. Inspection sheet akan dibuat setelah save.
                        </div>
