...
Route::middleware('auth.ckd')->group(function () {
    ...
    Route::middleware('auth.ckd:admin')->group(function () {
        ...
        Route::put('master/{master}/components/{component}', [MasterModelController::class, 'updateComponent'])->name('master.component.update');
        Route::post('master/{master}/components', [MasterModelController::class, 'storeComponent'])->name('master.component.store');
        Route::delete('master/{master}/components/{component}', [MasterModelController::class, 'destroyComponent'])->name('master.component.destroy');
        Route::post('/master/{master}/component/{component}/toggle', [MasterModelController::class, 'toggleComponent'])->name('master.component.toggle');
    });
    ...
    Route::middleware('auth.ckd:admin,inspector')->group(function () {
        ...
        Route::put('inspection/{inspection}/items/{item}', [InspectionController::class, 'updateItem'])
    ->name('inspection.item.update');
    });
